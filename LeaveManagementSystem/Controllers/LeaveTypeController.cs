...
namespace LeaveManagementSystem.Controllers
{
    public class LeaveTypeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,LeaveName,TotalDays")] LeaveType leaveType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LeaveName,TotalDays")] LeaveType leaveType)
        {
            if (id != leaveType.Id)
            {
                return NotFound();
